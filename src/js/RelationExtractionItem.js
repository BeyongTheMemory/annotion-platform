    ...
    render() {
        ...
        return (
            <div style={{
                ...
                <div style={{width: '100%'}}>
                    <font size="6" style={{float: 'left'}}> ID: {this.state.ep_num} </font>
                    ...
                    }} style={{width: 400, position: 'relative', top: -10}}>
                ...
                <div style={{
                    textAlign: 'left', marginTop: 70, height: 50, lineHeight: '32px', width: '100%'
                }}>
                    <Input
